...
import { setCartItems, setCartStore, visibilityCart, setDisplayToast } from '../../../actions/user';
...
function Cart({ accessToken }) {
    ...
    const handleNavigateCheckout = () => {
        ...
        const action = visibilityCart(!isCart);
        dispatch(action);
        navigate('/checkout', { state: { selectedItems, orderSource: 'online' } });
    }
