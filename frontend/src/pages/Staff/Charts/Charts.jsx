...
function Charts(props) {
 ...
 <h2 className="title-admin mb-0" style={{ fontSize: '24px', fontWeight: '600', color: '#2d3748', marginLeft: '0', paddingLeft: '0', marginBottom: '30px', paddingBottom: '20px' }}>Management Revenue
 ...
 <Form.Label>from ngày</Form.Label>
 ...
 <button className='btn btn-revenue'>Statistics</button>
 ...
 <th>Total Revenue</th>
 <th>Total Orders</th>
 <th>Price trị trung bình/order</th>
 </tr>
 </thead>
 <tbody>
 <tr>
 <td className='text-success font-weight-bold'>{summary.totalRevenue.toLocaleString()} VND</td>
 <td>{summary.totalOrders} order</td>
 <td>{summary.avgOrderValue.toLocaleString()} VND</td>
 </tr>
 </tbody>
 </table>
 </div>
