...
function Customer() {
 ...
 <h2 className="title-admin mb-4" style={{ fontSize: '24px', fontWeight: '600', color: '#2d3748' }}>Management Customers
 ...
 <h2 className="title-admin mb-0" style={{ fontSize: '24px', fontWeight: '600', color: '#2d3748', marginLeft: '0', paddingLeft: '0' }}>Management Customers
 <style>{`.title-admin::after { display: none !important; }`}</style> </h2>
 ...
 <Form.Control
 type="text"
 placeholder="Tìm theo Name, Email, SĐT..."
 value={searchTerm}
 ...
 <button className="btn btn-success ms-3 d-flex align-items-center gap-2" onClick={handleShowAddModal} style={{ padding: '10px 22px', borderRadius: '8px', fontWeight: '500' }}> <FaPlus /> Add khách hàng</button>
 </div>
 </div>
 ...
 <button
 className="btn btn-sm btn-link p-1"
 title={isLocked ?"Mở khóa tài khoản" :"Locked tài khoản"}
