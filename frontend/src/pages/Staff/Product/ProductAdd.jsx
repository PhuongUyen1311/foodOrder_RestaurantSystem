...
function ProductAdd(props) {
 ...
 <h3 className="title-admin">Add mới sản phẩm</h3>
 ...
 <Form.Group className='mb-4'>
 <Form.Label>Price sản phẩm</Form.Label>
 <Form.Control
 // required
 ...
 <Button className='btn btn-add' type="submit">Add mới</Button>
 </form>
